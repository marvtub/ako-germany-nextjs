            ...
            <div className="container max-w-screen-2xl mx-auto px-4">
                ...
                <div className="w-full lg:w-6/12 lg:px-4 ">
                    ...
                    <div className="w-full lg:w-4/12 px-4 ml-auto">
                        <span className="block uppercase text-rose-600 text-sm font-semibold mb-3 mt-3">Nützliche Links</span>
                ...
                <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                    ...
                    Copyright © <span id="get-current-year">2021 AKO Germany <br/> Built by </span>
                    <a href="https://www.marvinaziz.de" className="text-rose-600 hover:text-white transition duration-300 eas-in-out link link-underline link-underline-black">Marvin Aziz</a>.
                    </div>
