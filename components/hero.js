            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block xl:inline hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r hover:from-blue-100 hover:to-blue-900 transition-colors duration-300">Effiziente Kühlketten</span>{" "}
                  <span className="block text-rose-700 xl:inline">
                    auf Knopfdruck
                  </span>
                </h1>
